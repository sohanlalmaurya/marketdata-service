...
import com.sapient.marketdata.service.enumation.Side;
import com.sapient.marketdata.service.enumation.TradeStatus;
...
public class TradesModel {
	...
	public static class CommodityModel {
		...
		public String toString() {
			return "CommodityModel [id=" + id + ", name=" + name + "]";
		}
	...
	public static class CounterpartyModel {
		...
		@Override
		public String toString() {
			return "CounterpartyModel [id=" + id + ", name=" + name + "]";
		}
	...
	@Override
	public String toString() {
		return "TradesModel [tradeId=" + tradeId + ", side=" + side + ", quantity=" + quantity + ", price=" + price
